...
__global__ void cuContacts(double *pxyz, double *lxyz, double *cudists, int *plength)
{
...
/* launch the kernel on the GPU */
  cuContacts<<< (cudists_size / THREADS_PER_BLOCK + 1), THREADS_PER_BLOCK >>>( d_pxyz, d_lxyz, d_cudists, d_plength );
  checkKERNEL();
